      ...
      {isOpen && (
        ...
        >
          ...
          <motion.div
            ...
            className="relative z-10 w-full max-w-[430px] bg-white rounded-t-[32px] sm:rounded-[28px] border border-[#E1E6E2] shadow-[0_12px_40px_rgba(32,37,34,0.12)] max-h-[90dvh] flex flex-col overflow-hidden"
          >
            {/* Header */}
            <div className="px-6 pt-5 pb-4 border-b border-[#E1E6E2] flex items-center justify-between">
              <div>
                <h2
                  id="product-modal-title"
                  className="text-[20px] font-bold text-[#202522]"
                >
                  {isEditing ? 'Edit product' : 'Add product'}
                </h2>
                <p className="text-[13px] text-[#68716C] mt-0.5">
              ...
              <button
                type="button"
                onClick={onClose}
                className="w-9 h-9 rounded-full bg-white border border-[#E1E6E2] flex items-center justify-center text-[#68716C] hover:text-[#202522] transition-colors cursor-pointer"
                aria-label="Close"
              >
                <X size={18} />
              </button>
            ...
            <form onSubmit={handleSubmit} className="overflow-y-auto px-6 py-5 space-y-4">
              {error && (
                <div className="p-3 bg-[#FDF0EE] border border-[#FADCDA] rounded-xl text-[13px] text-[#202522] flex items-center gap-2">
              ...
              <div id="product-photo-upload-section">
                <label className="block text-[13px] font-medium text-[#202522] mb-1.5">
                  Product photo
                </label>
                ...
                {imagePreview ? (
                  <div className="relative w-48 h-48 aspect-square flex-shrink-0 mt-2">
                    <div className="w-full h-full rounded-2xl overflow-hidden border border-[#E1E6E2] bg-[#FAFBFB] shadow-2xs">
                      <img
                        src={imagePreview}
                        alt="Product preview"
                    ...
                    <button
                      ...
                      className="absolute top-0 right-0 -translate-y-1/2 translate-x-1/2 w-8 h-8 rounded-full bg-white hover:bg-[#D94841] text-[#D94841] hover:text-white border border-[#E1E6E2] hover:border-[#D94841] flex items-center justify-center transition-all cursor-pointer shadow-md z-10 active:scale-95"
                      title="Delete photo"
              ...
              <div>
                <label
                  ...
                  className="block text-[13px] font-medium text-[#202522] mb-1.5"
                >
                  Product name
                </label>
                <input
              ...
              <div>
                ...
                <div id="product-category-container" className="relative">
                  ...
                  <div
                    className="absolute right-3 top-1/2 -translate-y-1/2 pointer-events-none w-6 h-6 flex items-center justify-center text-[#68716C]"
                    aria-hidden="true"
                  >
                    <ChevronDown
                      size={17}
                ...
                <div>
                  <div className="flex items-baseline justify-between mb-1.5">
                    <label
                      ...
                      className="text-[12.5px] sm:text-[13px] font-medium text-[#202522] truncate"
                    >
                      SKU / Barcode
                    </label>
                    <span className="text-[10.5px] font-normal text-[#68716C] shrink-0 ml-1">
                      Optional
                    </span>
                  </div>
              ...
              >
                ...
                {isEditing && (
                  <button
                    ...
                    className="w-full h-11 bg-transparent text-[#D94841] text-[14px] font-medium rounded-xl flex items-center justify-center gap-1.5 cursor-pointer hover:bg-[#D94841]/10 active:bg-[#D94841]/20 transition-colors"
                  >
                    <Trash2 size={16} />
